 ...
 */
function _membershipextras_civix_civicrm_postInstall() {
  _membershipextras_civix_civicrm_config();
  if ($upgrader = _membershipextras_civix_upgrader()) {
 ...
 * @return mixed
 */
function _membershipextras_civix_civicrm_disable() {
  _membershipextras_civix_civicrm_config();
  if ($upgrader = _membershipextras_civix_upgrader()) {
 ...
 */
function _membershipextras_civix_civicrm_upgrade($op, CRM_Queue_Queue $queue = NULL) {
  if ($upgrader = _membershipextras_civix_upgrader()) {
...
/**
 * @return CRM_MembershipExtras_Upgrader
 */
function _membershipextras_civix_upgrader() {
  if (!file_exists(__DIR__ . '/CRM/MembershipExtras/Upgrader.php')) {
    return NULL;
  }
  else {
    return CRM_MembershipExtras_Upgrader_Base::instance();
  }
}
  ...
  if (empty($path)) {
    ...
    foreach ($menu as $key => &$entry) {
      if ($entry['attributes']['name'] == $first) {
        ...
        $found = _membershipextras_civix_insert_navigation_menu($entry['child'], implode('/', $path), $item, $key);
      }
    }
    return $found;
  }
...
function _membershipextras_civix_civicrm_entityTypes(&$entityTypes) {
  $entityTypes = array_merge($entityTypes, array (
    ...
    'CRM_MembershipExtras_DAO_MembershipPeriod' => 
    array (
      'name' => 'MembershipPeriod',
      'class' => 'CRM_MembershipExtras_DAO_MembershipPeriod',
      'table' => 'membershipextras_membership_period',
    ),
  ));
}

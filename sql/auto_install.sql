...
-- /*******************************************************
-- *
-- * membershipextras_contribrecur_lineitem
-- *
...
CREATE TABLE `membershipextras_contribrecur_lineitem` (
     ...
     UNIQUE INDEX `index_contribrecurid_lineitemid` (
        contribution_recur_id, line_item_id
     ),
     CONSTRAINT FK_membershipextras_contribrecur_lineitem_contribution_recur_id FOREIGN KEY (`contribution_recur_id`) REFERENCES `civicrm_contribution_recur`(`id`) ON DELETE CASCADE,
     CONSTRAINT FK_membershipextras_contribrecur_lineitem_line_item_id FOREIGN KEY (`line_item_id`) REFERENCES `civicrm_line_item`(`id`) ON DELETE CASCADE  
);

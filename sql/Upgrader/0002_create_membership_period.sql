...
CREATE TABLE `membershipextras_membership_period` (
  ...
  `payment_entity_table` varchar(64) NULL   COMMENT 'Either civicrm_contribution or civicrm_contribution_recur.',
  `entity_id` int unsigned NULL   COMMENT 'ID of the payment entity.',
